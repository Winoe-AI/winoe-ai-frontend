...
describe('candidate api run status normalization', () => {
  ...
  it('normalizes running/timeout/error/completed statuses', async () => {
    ...
    await expect(pollCandidateTestRun(params('run-a'))).resolves.toEqual({
      status: 'running',
      message: undefined,
      passed: null,
      failed: null,
    ...
    await expect(pollCandidateTestRun(params('run-b'))).resolves.toEqual({
      status: 'timeout',
      message: undefined,
      passed: null,
      failed: null,
    ...
    await expect(pollCandidateTestRun(params('run-c'))).resolves.toEqual({
      status: 'timeout',
      message: undefined,
      passed: null,
      failed: null,
    ...
    await expect(pollCandidateTestRun(params('run-d'))).resolves.toEqual({
      status: 'error',
      passed: null,
      failed: null,
      total: null,
    ...
    await expect(pollCandidateTestRun(params('run-e'))).resolves.toEqual({
      status: 'failed',
      message: 'Red',
      passed: null,
      failed: null,
    ...
    await expect(pollCandidateTestRun(params('run-f'))).resolves.toEqual({
      status: 'failed',
      message: undefined,
      passed: null,
      failed: null,
    ...
    await expect(pollCandidateTestRun(params('run-g'))).resolves.toEqual({
      status: 'passed',
      message: undefined,
      passed: null,
      failed: null,
    ...
    await expect(pollCandidateTestRun(params('run-h'))).resolves.toEqual({
      status: 'timeout',
      message: undefined,
      passed: null,
      failed: null,
    ...
    await expect(pollCandidateTestRun(params('run-i'))).resolves.toEqual({
      status: 'error',
      message: undefined,
      passed: null,
      failed: null,
