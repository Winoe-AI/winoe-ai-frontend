...
export const recruiterDashboardMock = jest.fn(() => <div data-testid="recruiter-dashboard" />);
export const simulationDetailMock = jest.fn(() => <div data-testid="simulation-detail" />);
export const simulationCreateMock = jest.fn(() => <div data-testid="simulation-create" />);
export const candidateSubmissionsMock = jest.fn(() => <div data-testid="candidate-submissions" />);
...
jest.mock('@/features/marketing/home/MarketingHomePage', () => ({
  __esModule: true,
  default: (props: any) => marketingMock(props),
}));
jest.mock('@/features/candidate/dashboard/CandidateDashboardPage', () => ({
  __esModule: true,
  default: (props: any) => candidateDashboardMock(props),
}));
jest.mock('@/features/recruiter/dashboard/RecruiterDashboardPage', () => ({
  __esModule: true,
  default: () => recruiterDashboardMock(),
}));
jest.mock('@/features/recruiter/simulations/detail/RecruiterSimulationDetailPage', () => ({
  __esModule: true,
...
jest.mock('@/app/(candidate)/(legacy)/candidate-sessions/token-params', () => {
  const actual = jest.requireActual('@/app/(candidate)/(legacy)/candidate-sessions/token-params');
  return { ...actual, requireCandidateToken: requireCandidateTokenMock };
});
jest.mock('@/features/candidate/session/CandidateSessionPage', () => ({
  __esModule: true,
  default: ({ token }: { token: string }) => <div data-testid="candidate-session-page">{token}</div>,
}));
