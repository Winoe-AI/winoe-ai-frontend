import { computeLatestArtifacts } from '@/features/recruiter/simulations/candidates/hooks/computeLatestArtifacts';
import type {
  SubmissionArtifact,
  SubmissionListItem,
} from '@/features/recruiter/simulations/candidates/types';
