...
describe('RecruiterSimulationDetailPage component interactions', () => {
  ...
  it('filters candidates by search input', async () => {
    listSimulationCandidatesMock.mockResolvedValue([
      { candidateSessionId: 1, candidateName: 'Alice', inviteEmail: 'alice@test.com', inviteUrl: 'http://invite' },
      { candidateSessionId: 2, candidateName: 'Bob', inviteEmail: 'bob@test.com', inviteUrl: 'http://invite' },
    ]);
    await renderDetailPage();
