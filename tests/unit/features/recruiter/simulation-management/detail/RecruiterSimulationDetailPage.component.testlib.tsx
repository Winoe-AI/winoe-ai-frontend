...
jest.mock('@/features/recruiter/utils/formattersUtils', () => {
  const actual = jest.requireActual(
    '@/features/recruiter/utils/formattersUtils',
  );
...
jest.mock(
  '@/features/recruiter/simulation-management/invitations/InviteCandidateModal',
  () => ({
...
export const copyInviteLinkMock = (
  jest.requireMock('@/features/recruiter/utils/formattersUtils') as {
