import { loadArtifacts } from '@/features/recruiter/submission-review/hooks/useArtifactLoader';

const fetchArtifactsWithLimitMock = jest.fn();

jest.mock(
  '@/features/recruiter/submission-review/utils/candidateSubmissionsApiUtils',
  () => ({
