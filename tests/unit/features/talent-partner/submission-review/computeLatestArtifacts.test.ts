import { computeLatestArtifacts } from '@/features/talent-partner/submission-review/hooks/useComputeLatestArtifacts';
import type {
  SubmissionArtifact,
  SubmissionListItem,
} from '@/features/talent-partner/submission-review/types';
