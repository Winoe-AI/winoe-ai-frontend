import { normalizeWinoeReportPayload } from '@/features/talent-partner/winoe-report/winoeReport.api';

describe('normalizeWinoeReportPayload', () => {
  it('treats human_review_required day scores as AI-disabled', () => {
    ...
    const result = normalizeWinoeReportPayload(payload);
