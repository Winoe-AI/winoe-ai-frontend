...
import { EvidenceList } from '@/features/talent-partner/winoe-report/EvidenceList';
import { WinoeReportWarningBanner } from '@/features/talent-partner/winoe-report/WinoeReportWarningBanner';

describe('Winoe Report components states', () => {
