...
export function buildDefaultArtifacts(candidateSessionId: number) {
  return {
    ...
    502: {
      ...
      contentText: null,
      repoUrl: 'https://github.com/winoe-ai/candidate-repo',
      repoFullName: 'winoe-ai/candidate-repo',
      workflowUrl: 'https://github.com/winoe-ai/candidate-repo/actions/runs/2',
      testResults: {
        passed: 22,
        failed: 0,
        total: 22,
    ...
    503: {
      ...
      repoUrl: 'https://github.com/winoe-ai/candidate-repo',
      repoFullName: 'winoe-ai/candidate-repo',
      workflowUrl: 'https://github.com/winoe-ai/candidate-repo/actions/runs/3',
      testResults: {
        passed: 20,
        failed: 1,
        total: 21,
