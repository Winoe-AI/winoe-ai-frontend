...
DRIVER_SEQUENCE_RAW="${CONTRACT_LIVE_DRIVER_SEQUENCE:-recruiter-fresh}"
...
export TENON_EMAIL_PROVIDER="${TENON_EMAIL_PROVIDER:-console}"
...
write_report() {
...

  {
    ...
    echo "- Email provider: \`${TENON_EMAIL_PROVIDER}\`"
...
echo "TENON_EMAIL_PROVIDER: $TENON_EMAIL_PROVIDER" | tee -a "$RUNNER_LOG"
