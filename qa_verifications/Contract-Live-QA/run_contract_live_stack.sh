...
BACKEND_DIR="$REPO_ROOT/tenon-backend"
QA_ROOT="$SCRIPT_DIR"
...
EMAIL_PROVIDER="${TENON_EMAIL_PROVIDER:-console}"
...
TENON_TEST_NOW_UTC=$FAKE_TIME_UTC
NEXT_PUBLIC_TENON_TEST_NOW_UTC=$FAKE_TIME_UTC
TENON_EMAIL_PROVIDER=$EMAIL_PROVIDER
TENON_AUTH0_LEEWAY_SECONDS=$AUTH0_LEEWAY_SECONDS
...
(
  cd "$BACKEND_DIR"
  export TENON_EMAIL_PROVIDER="$EMAIL_PROVIDER"
  export TENON_AUTH0_LEEWAY_SECONDS="$AUTH0_LEEWAY_SECONDS"
  export DEV_AUTH_BYPASS="${DEV_AUTH_BYPASS:-0}"
  export TENON_DEV_AUTH_BYPASS="${TENON_DEV_AUTH_BYPASS:-0}"
  export CONTRACT_LIVE_FAKE_TIME_UTC="$FAKE_TIME_UTC"
  export TENON_TEST_NOW_UTC="$FAKE_TIME_UTC"
...
(
  ...
  export CONTRACT_LIVE_FAKE_TIME_UTC="$FAKE_TIME_UTC"
  export TENON_TEST_NOW_UTC="$FAKE_TIME_UTC"
  export NEXT_PUBLIC_TENON_TEST_NOW_UTC="$FAKE_TIME_UTC"
