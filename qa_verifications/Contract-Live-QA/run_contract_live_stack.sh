...
WINOE_REPORT_DAY1_RUNTIME_MODE="${CONTRACT_LIVE_WINOE_REPORT_DAY1_RUNTIME_MODE:-${WINOE_REPORT_DAY1_RUNTIME_MODE:-demo}}"
WINOE_WINOE_REPORT_DAY1_RUNTIME_MODE="$WINOE_REPORT_DAY1_RUNTIME_MODE"
WINOE_REPORT_DAY23_RUNTIME_MODE="${CONTRACT_LIVE_WINOE_REPORT_DAY23_RUNTIME_MODE:-${WINOE_REPORT_DAY23_RUNTIME_MODE:-demo}}"
WINOE_WINOE_REPORT_DAY23_RUNTIME_MODE="$WINOE_REPORT_DAY23_RUNTIME_MODE"
WINOE_REPORT_DAY4_RUNTIME_MODE="${CONTRACT_LIVE_WINOE_REPORT_DAY4_RUNTIME_MODE:-${WINOE_REPORT_DAY4_RUNTIME_MODE:-demo}}"
WINOE_WINOE_REPORT_DAY4_RUNTIME_MODE="$WINOE_REPORT_DAY4_RUNTIME_MODE"
WINOE_REPORT_DAY5_RUNTIME_MODE="${CONTRACT_LIVE_WINOE_REPORT_DAY5_RUNTIME_MODE:-${WINOE_REPORT_DAY5_RUNTIME_MODE:-demo}}"
WINOE_WINOE_REPORT_DAY5_RUNTIME_MODE="$WINOE_REPORT_DAY5_RUNTIME_MODE"
WINOE_REPORT_AGGREGATOR_RUNTIME_MODE="${CONTRACT_LIVE_WINOE_REPORT_AGGREGATOR_RUNTIME_MODE:-${WINOE_REPORT_AGGREGATOR_RUNTIME_MODE:-demo}}"
WINOE_WINOE_REPORT_AGGREGATOR_RUNTIME_MODE="$WINOE_REPORT_AGGREGATOR_RUNTIME_MODE"
WINOE_TRANSCRIPTION_RUNTIME_MODE="${CONTRACT_LIVE_WINOE_TRANSCRIPTION_RUNTIME_MODE:-${WINOE_TRANSCRIPTION_RUNTIME_MODE:-demo}}"
...
if [[ "$USE_LOCAL_DEV_AUTH" -eq 1 ]]; then
  export CONTRACT_LIVE_AUTH_BOOTSTRAP_MODE="local-dev-fallback"
else
  export CONTRACT_LIVE_AUTH_BOOTSTRAP_MODE="real-auth0"
fi
...
WINOE_REPORT_DAY1_RUNTIME_MODE=$WINOE_REPORT_DAY1_RUNTIME_MODE
WINOE_WINOE_REPORT_DAY1_RUNTIME_MODE=$WINOE_WINOE_REPORT_DAY1_RUNTIME_MODE
WINOE_REPORT_DAY23_RUNTIME_MODE=$WINOE_REPORT_DAY23_RUNTIME_MODE
WINOE_WINOE_REPORT_DAY23_RUNTIME_MODE=$WINOE_WINOE_REPORT_DAY23_RUNTIME_MODE
WINOE_REPORT_DAY4_RUNTIME_MODE=$WINOE_REPORT_DAY4_RUNTIME_MODE
WINOE_WINOE_REPORT_DAY4_RUNTIME_MODE=$WINOE_WINOE_REPORT_DAY4_RUNTIME_MODE
WINOE_REPORT_DAY5_RUNTIME_MODE=$WINOE_REPORT_DAY5_RUNTIME_MODE
WINOE_WINOE_REPORT_DAY5_RUNTIME_MODE=$WINOE_WINOE_REPORT_DAY5_RUNTIME_MODE
WINOE_REPORT_AGGREGATOR_RUNTIME_MODE=$WINOE_REPORT_AGGREGATOR_RUNTIME_MODE
WINOE_WINOE_REPORT_AGGREGATOR_RUNTIME_MODE=$WINOE_WINOE_REPORT_AGGREGATOR_RUNTIME_MODE
WINOE_TRANSCRIPTION_RUNTIME_MODE=$WINOE_TRANSCRIPTION_RUNTIME_MODE
...
echo "Contract-live Winoe report day1 runtime mode: $WINOE_REPORT_DAY1_RUNTIME_MODE"
echo "Contract-live Winoe report day23 runtime mode: $WINOE_REPORT_DAY23_RUNTIME_MODE"
echo "Contract-live Winoe report day4 runtime mode: $WINOE_REPORT_DAY4_RUNTIME_MODE"
echo "Contract-live Winoe report day5 runtime mode: $WINOE_REPORT_DAY5_RUNTIME_MODE"
echo "Contract-live Winoe report aggregator runtime mode: $WINOE_REPORT_AGGREGATOR_RUNTIME_MODE"
echo "Contract-live transcription runtime mode: $WINOE_TRANSCRIPTION_RUNTIME_MODE"
if [[ "$USE_LOCAL_DEV_AUTH" -eq 1 ]]; then
  echo "Contract-live auth bootstrap mode: local dev auth bypass (local proof only; not production Auth0 certification)"
else
  echo "Contract-live auth bootstrap mode: real Auth0 (local proof only; not production Auth0 certification)"
fi
echo "Contract-live auth boundary: Local contract-live QA proves the local product flow, worker execution, Winoe Report generation, Evidence Trail persistence, and UI readiness. It does not certify production Auth0 reliability."
if [[ -n "${STACK_LABEL// }" ]]; then
...
bootstrap_local_database() {
  ...
  (
    ...
    export WINOE_REPORT_DAY1_RUNTIME_MODE="$WINOE_REPORT_DAY1_RUNTIME_MODE"
    export WINOE_WINOE_REPORT_DAY1_RUNTIME_MODE="$WINOE_WINOE_REPORT_DAY1_RUNTIME_MODE"
    export WINOE_REPORT_DAY23_RUNTIME_MODE="$WINOE_REPORT_DAY23_RUNTIME_MODE"
    export WINOE_WINOE_REPORT_DAY23_RUNTIME_MODE="$WINOE_WINOE_REPORT_DAY23_RUNTIME_MODE"
    export WINOE_REPORT_DAY4_RUNTIME_MODE="$WINOE_REPORT_DAY4_RUNTIME_MODE"
    export WINOE_WINOE_REPORT_DAY4_RUNTIME_MODE="$WINOE_WINOE_REPORT_DAY4_RUNTIME_MODE"
    export WINOE_REPORT_DAY5_RUNTIME_MODE="$WINOE_REPORT_DAY5_RUNTIME_MODE"
    export WINOE_WINOE_REPORT_DAY5_RUNTIME_MODE="$WINOE_WINOE_REPORT_DAY5_RUNTIME_MODE"
    export WINOE_REPORT_AGGREGATOR_RUNTIME_MODE="$WINOE_REPORT_AGGREGATOR_RUNTIME_MODE"
    export WINOE_WINOE_REPORT_AGGREGATOR_RUNTIME_MODE="$WINOE_WINOE_REPORT_AGGREGATOR_RUNTIME_MODE"
    export WINOE_TRANSCRIPTION_RUNTIME_MODE="$WINOE_TRANSCRIPTION_RUNTIME_MODE"
...
# The app shell is the stable readiness signal in dev. The API health route is
# proxied through the frontend and can lag behind route compilation in watch
# mode, which makes it a poor bootstrap gate.
wait_for_url "http://$FRONTEND_HOST:$FRONTEND_PORT" "Frontend" "$FRONTEND_PID"
