...
import type { FitProfileDayScore } from './fitProfile.types';
    ...
    <Card className="fit-profile-avoid-break space-y-3">
      ...
      {isNotEvaluated ? (
        <p className="text-sm text-gray-600">
          This day was not evaluated and does not affect overall fit score.
        </p>
      ) : null}
      ...
      <div>
        <h3 className="text-sm font-semibold text-gray-900">Evidence Trail</h3>
        <div className="mt-2">
