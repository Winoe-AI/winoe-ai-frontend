...
import type { FitProfileFetchOutcome, FitProfileState } from './fitProfile.types';
import {
  accessDeniedState,
  errorState,
  generatingState,
...
export function stateFromOutcome(outcome: FitProfileFetchOutcome): FitProfileState {
