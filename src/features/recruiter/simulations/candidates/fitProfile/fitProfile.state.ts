...
export function generatingState(message = 'Generating Fit Profile...'): FitProfileState {
...
export function errorState(message: string, errorCode: string | null = null): FitProfileState {
