...
export function SimulationPlanSectionBody(props: SimulationPlanSectionBodyProps) {
  ...
  if (props.error) {
    return <SimulationPlanErrorState onRetry={props.onRetry} message={props.error} />;
  }
  ...
  return (
    <div className="mt-4 flex flex-col gap-4">
      ...
      {props.contentUnavailableMessage ? (
        <SimulationPlanContentUnavailable message={props.contentUnavailableMessage} />
