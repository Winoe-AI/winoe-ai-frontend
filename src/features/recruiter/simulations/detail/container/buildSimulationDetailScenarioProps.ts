...
export function buildSimulationDetailScenarioProps({
  ...
  return {
    ...
    scenarioContentUnavailableMessage: scenario.scenarioContentUnavailableMessage,
    ...
    scenarioContentUnavailableMessageForPlan: scenario.scenarioContentUnavailableMessage,
    planDays: scenario.displayedPlanDays,
    planLoading,
    planStatusCode,
    generating: isGenerating || scenario.selectedScenarioVersion?.uiStatus === 'generating',
