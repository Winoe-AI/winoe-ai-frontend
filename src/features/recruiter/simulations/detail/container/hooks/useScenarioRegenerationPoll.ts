...
export function useScenarioRegenerationPoll({
  ...
  useEffect(() => {
    ...
    const activeMatches = detail.activeScenarioVersionId === regeneratedVersionId;
    const pendingMatches = detail.pendingScenarioVersionId === regeneratedVersionId;
