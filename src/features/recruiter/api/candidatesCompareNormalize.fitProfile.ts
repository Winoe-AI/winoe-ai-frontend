import { asRecord, normalizeStatus } from './candidatesCompareNormalize.records';
import type { CandidateCompareFitProfileStatus } from './candidatesCompareNormalize.types';
