import { TEMPLATE_OPTIONS } from '@/platform/config/templateCatalog';
...
export function TrialTemplateSelect({
  values,
  errors,
  isSubmitting,
  onChange,
  ...
  return (
    <div>
      ...
      <TrialFieldError id="templateKey-error" message={errors.templateKey} />
    </div>
  );
}
