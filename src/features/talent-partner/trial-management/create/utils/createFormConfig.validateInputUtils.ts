...
import { MAX_PROMPT_OVERRIDE_MARKDOWN_CHARS } from '@/features/talent-partner/ai/promptOverrideFormUtils';
...
const SENIORITY_SET = new Set<TrialRoleLevel>(SENIORITY_OPTIONS);
