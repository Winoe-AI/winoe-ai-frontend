...
export function TerminateTrialModal({
  open,
  pending,
  onClose,
  onConfirm,
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="terminate-trial-title"
      data-testid="terminate-trial-modal"
    >
      <div className="w-full max-w-xl rounded-lg border border-red-200 bg-white p-5 shadow-lg">
        <h2
          id="terminate-trial-title"
        ...
        <label className="mt-4 flex cursor-pointer items-start gap-2 rounded border border-gray-200 bg-gray-50 p-3 text-sm text-gray-800">
          <input
            ...
            aria-label="confirm-terminate-trial"
          />
          <span>
