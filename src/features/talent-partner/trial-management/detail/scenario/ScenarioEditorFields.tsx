    ...
    <div className="mt-3 grid gap-3">
      <label className="grid gap-1">
        ...
        <textarea
          ...
          aria-invalid={Boolean(
            storylineError || serverFieldErrors?.storylineMd,
          )}
        />
        {storylineError ? (
          <span className="text-xs text-red-700">{storylineError}</span>
        ) : null}
      ...
      <label className="grid gap-1">
        ...
        <textarea
          ...
          disabled={disabled}
          aria-invalid={Boolean(
            taskPromptsError || serverFieldErrors?.taskPrompts,
          )}
        />
        {taskPromptsError ? (
      ...
      <label className="grid gap-1">
        ...
        />
        {rubricError ? (
          <span className="text-xs text-red-700">{rubricError}</span>
        ) : null}
