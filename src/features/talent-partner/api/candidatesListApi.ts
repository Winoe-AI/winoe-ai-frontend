...
const CANDIDATE_CACHE_STORE_KEY = '__winoeTalentPartnerCandidateCacheStore';
...
export function listTrialCandidates(
  ...
  const request = talentPartnerBffClient
    .get<unknown>(`/trials/${encodeURIComponent(id)}/candidates`, {
